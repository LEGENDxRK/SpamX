...
pongg = PING_MSG if PING_MSG else "Venom-Sᴘᴀᴍ X"
RIZ_PIC = ALIVE_PIC if ALIVE_PIC else "https://telegra.ph/file/4c13beea0f4b44999a48b.jpg"
Alivemsg = ALIVE_MSG if ALIVE_MSG else "𝐕𝐄𝐍𝐎𝐌~𝗦𝗽𝗮𝗺𝗫 𝗛𝗲𝗿𝗲."
...
rizoel += f"➠ **Venom-SᴘᴀᴍX ᴠᴇʀsɪᴏɴ**  : `{__version__}`\n"
rizoel += f"➠ **ᴄʜᴀɴɴᴇʟ** : [Join.](https://t.me/dostokijaan)\n"
rizoel += f"━───────╮•╭───────━\n\n"
rizoel += f"➠ **Source Code:** [•Repo•](https://github.com/venomowners20912/SpamX)"
